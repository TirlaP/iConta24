...
export const StrapiHero: React.FC<StrapiHeroProps> = ({
  locale = "ro",
  data
}) => {
  const {
    ...
    buttons = [
      { text: "HAI SĂ NE CUNOAȘTEM!", URL: "/contact", variant: "primary" as const },
      { text: "Vezi Serviciile", URL: "/servicii", variant: "secondary" as const }
    ]
  } = data || {};
            ...
            >
              {buttons.map((button, index) => (
                <Link 
                  ...
                  className={button.variant === 'primary' ? 'btn-primary group' : 'btn-secondary'}
                >
                  {button.text}
